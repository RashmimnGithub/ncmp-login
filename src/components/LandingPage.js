...
import monitoring from "../assets/yqgzPwOk.jpg";
...
import userLogo from "../assets/yqgzPwOk.jpg";
import logo from "../assets/yqgzPwOk.jpg";
        ...
        <div className="content-panel">
          {selectedButton ? (
            <>
              ...
              <a href={selectedButton.path} target="_blank" rel="noopener noreferrer" className="doc-link">Click Here</a>
            </>
          ) : (
